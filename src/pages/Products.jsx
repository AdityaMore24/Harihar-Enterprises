...
const products = [
  ...
  },
  {
    ...
    description: "SAP (Super Absorbent Polymer) is a soft, flat layer inside the pad filled with tiny absorbent beads that provide exceptional liquid retention. These super absorbent polymer beads instantly transform menstrual fluid into thick gel upon contact, locking fluid securely in place to prevent leakage and surface moisture. Our high-capacity SAP technology delivers superior absorption power that keeps the pad consistently dry, safe, and comfortable during extended wear. Experience unmatched security with our super absorbent polymer layer that provides reliable fluid locking and maintains optimal dryness for long-lasting comfort throughout your cycle.",
  ...
  },
  {
    ...
    description: "PE Film is a soft plastic sheet positioned at the bottom of the pad that serves as the primary waterproof barrier. This breathable PE backsheet completely prevents liquid penetration while allowing air circulation for optimal comfort and freshness. Our flexible polyethylene film is thin and durable, designed to block wetness while maintaining breathability. The leak-proof PE layer keeps clothes completely clean and dry by creating an impermeable seal. Experience total protection with our waterproof PE film backsheet that delivers reliable leakage prevention and provides a comfortable dry feeling throughout extended wear.",
  ...
  },
  {
    ...
    description: "Body Tape is a specialized adhesive tape used by fashion designers to secure clothing directly onto the body for seamless styling. This double-sided silicon body tape features silicon coating on both sides that provides strong adhesion without skin damage. Our skin-safe fashion tape uses gentle, hypoallergenic adhesive that prevents itching and rashes. The flexible body adhesive keeps garments perfectly positioned all day while remaining invisible under clothing. Experience reliable hold and comfortable wear with our premium fashion body tape for backless and strapless outfits.",
  ...
  },
  {
    ...
    description: "Silicon to silicon gumming is a specialized adhesive technique used to bond two silicon-coated surfaces in hygiene products. This advanced silicon bonding method ensures secure adhesion without compromising flexibility or comfort. Our silicon-to-silicon adhesive system provides seamless component integration while maintaining product integrity. Experience superior construction with our precision silicon gumming technology that delivers lasting adhesion and optimal performance.",
...
},
{
    ...
    description: "The collar pad is a specialized insert used in shirt manufacturing to maintain collar shape and provide structured support. This collar reinforcement pad prevents collar deformation and maintains a crisp, professional appearance throughout wear. Our structured collar insert eliminates wrinkles and provides better collar positioning and stability. Experience superior shirt construction with our premium collar pad technology that delivers structural integrity, prevents collar distortion, and ensures consistent professional appearance.",
...
},
{
    ...
    description: "The 35-40 mm strip gumming is a pressure-sensitive adhesive strip applied to the back of sanitary pads to ensure firm attachment to underwear. This optimal-width adhesive strip provides balanced hold without compromising comfort or causing bunching during wear. Our secure positioning strip ensures the pad stays firmly in place during movement, enhancing user confidence and preventing leaks. Experience superior pad security with our precision-width strip gumming that delivers reliable adhesion, maintains comfort, and provides worry-free protection throughout the day.",
  ...
  // Glass Raw Material
  {
    ...
    description: "The M4 Granite Marble Roll is a specialized protective layer designed for storage, transportation, and installation of granite and marble surfaces. This premium surface protection film prevents scratches, stains, and surface damage while ensuring materials retain their polished finish. Our durable marble protection roll features easy application and removal without residue, ideal for both industrial and on-site use. Experience superior stone protection with our M4 protective film that delivers reliable surface preservation and maintains material quality during handling and installation.",
...

{
  ...
  },
  {
    ...
    description: "Green Oxide is a premium-grade pigment widely used in flooring, tiles, paver blocks, and colored cement applications for superior color performance. This high-quality iron oxide pigment provides a rich, consistent green tone with excellent color stability and uniform distribution. Our fade-resistant green oxide offers exceptional durability and weather resistance, ensuring long-lasting color retention under harsh conditions. Experience superior coloring with our premium green oxide that provides consistent quality, excellent lightfastness, and reliable performance for construction and decorative applications.",
  ...
  },
  {
    ...
    description: "This glass etching stencil roll is a specialized sticky sheet for creating precise patterns on glass surfaces. Simply cut your shape, stick it on glass, and apply etching cream or sandblasting for clear, defined designs. Our adhesive stencil material provides clean finishing with sharp edges and works well on mirrors, windows, and glass doors. Experience superior customization with our premium stencil roll for both home DIY and professional glass etching projects.",
    ...
    description: "The aluminium suction lifter is a durable tool for lifting smooth surfaces like glass, tiles, and sheet metal. Made from lightweight yet strong aluminium construction, this professional suction lifter features powerful suction cups that create secure grip and reduce breakage risk. Our heavy-duty material lifter improves workplace safety during installation and transport operations. Experience reliable material handling with our premium aluminium suction lifter that delivers safety and efficiency for all lifting needs.",
